...
{
	public class ConsultantsBySumSalesFilter
	{
		public static IEnumerable<ConsultantsBySumSalesResponse> Filter(
			IEnumerable<ConsultantsBySumSalesResponse> list,
			...
			if (globalFilter != null)
			{
				...
				switch (globalFilter.SortOrder)
				{
					...
					case "index_desc":
						...
						break;
					default:
						list = list.OrderByDescending(s => s.ConsultantHierarchySaleSum);
						break;
				}
			}
